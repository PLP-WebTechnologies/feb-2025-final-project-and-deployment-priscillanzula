document.addEventListener('DOMContentLoaded', function () {
    ...
    const navToggle = document.querySelector('.nav-toggle') || document.getElementById('hamburger-menu');
    ...
    if (testimonialSlider) {
        ...
        testimonialSlider.addEventListener('touchend', e => {
            ...
            if (touchEndX < touchStartX - 50) { nextSlide(); startAutoplay(); }
            else if (touchEndX > touchStartX + 50) { prevSlide(); startAutoplay(); }
        }, false);
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function (e) {
            ...
            showNotification('You are now signed in! Restricted content is now visible.', 'success');
        });
    }
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', function(e) {
            ...
            showRestrictedContent();
            showNotification('Registration successful! Welcome to Aqua Zuri.', 'success');
        });
    }
    function signOut() {
        showPublicContent();
    ...
    // Add Sign Out Button to Footer (only once)
    const footer = document.querySelector('footer');
    if (footer && !footer.querySelector('.footer-btn.signout')) {
        const signOutButton = document.createElement('button');
        signOutButton.className = 'footer-btn signout';
